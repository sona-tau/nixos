...
#smartGaps = "on";
            ...
            output = {
                "*" = {
                    bg = lib.mkForce "~/Media/Pictures/Wallpapers/rock-tile.png tile";
                };
            };
#            output = {
#                "*" = {
#                    bg = "~/Media/Pictures/Wallpapers/bliss.png center";
#                };
#            };
#			output = {
#				"*" = {
#					bg = "~/Media/Pictures/Wallpapers/kanagawa-dragon.png fill";
#				};
#			};
            keybindings = let
