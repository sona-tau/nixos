		...
		programs.zsh = {
			enable = true;
				...
				shellAliases = {
					...
					"mail"     = "aerc";
					"s"        = "search";
					"powerwatch" = "watch -n5 'r1=$(cat /sys/class/powercap/intel-rapl/intel-rapl:0/energy_uj); sleep 5; r2=$(cat /sys/class/powercap/intel-rapl/intel-rapl:0/energy_uj); echo \"Package power: $(( (r2 - r1) / 5000000 )) W\"'";
